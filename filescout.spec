...
%files
/usr/bin/filescout
/usr/share/man/man1/filescout.1
%description
%{summary}
...
cd $RPM_BUILD_ROOT
cp %{_topdir}/usr/bin/filescout $RPM_BUILD_ROOT/usr/bin/
cp %{_topdir}/usr/share/man/man1/filescout.1 $RPM_BUILD_ROOT/usr/share/man/man1/filescout.1
